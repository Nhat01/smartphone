...
function initAdmin() {
    ...
    if(test == null) {
        ...
        signUpAccount.name = 'Hoàng Kim Tín'
        signUpAccount.email = 'tinhoangkim533@gmail.com'
        signUpAccount.phone = '0842809019'
        ...
        signInForm.addEventListener('submit' , (e) => {
            ...
            accountSignIn.forEach(account => {
                if(account.email == emailSignIn.value && account.password == passwordSignIn.value) {
                    ...
                    if(account.email == 'tinhoangkim533@gmail.com') {
...
window.addEventListener('load' , (e) => {
    ...
    if(JSON.parse(localStorage.getItem('signin'))) {
        ...
        if(JSON.parse(localStorage.getItem('signin')).email == 'tinhoangkim533@gmail.com') {
...
function handleFormStore () {
    ...
    if(arrCustomer) {
        arrCustomer.forEach((customer,index) => {
            if(customer.email != 'tinhoangkim533@gmail.com') {
                let tr = document.createElement('tr')
